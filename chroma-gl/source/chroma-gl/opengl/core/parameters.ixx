...
export namespace gl
{
    ...
    template<gl::sampler_parameter_e parameter_v>
    using sampler_parameter_argument_t = gl::sampler_parameter_argument<parameter_v>::type;
    ...
    template<gl::texture_parameter_e parameter_v>
    using texture_parameter_argument_t = gl::texture_parameter_argument<parameter_v>::type;
    ...
    template<gl::patch_parameter_e parameter_v>
    using patch_parameter_argument_t = gl::patch_parameter_argument<parameter_v>::type;
    ...
    template<gl::point_parameter_e parameter_v>
    using point_parameter_argument_t = gl::point_parameter_argument<parameter_v>::type;
    ...
    template<gl::frame_buffer_attachment_e attachment_v>
    using frame_buffer_attachment_argument_t = gl::frame_buffer_attachment_argument<attachment_v>::type;
}
