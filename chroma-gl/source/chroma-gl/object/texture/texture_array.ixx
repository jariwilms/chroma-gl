export module opengl.object.texture_array;
...
export namespace gl
{
    ...
    class texture_n_array : public gl::object
    {
    public:
        ...
        texture_n_array(gl::count_t element_count, format_e format, const vector_t& dimensions, gl::bool_t allocate_mipmaps = gl::true_)
            : gl::object{ gl::create_texture(gl::map_texture_array_target(Dimensions)) }
        ...
        texture_n_array(texture_n_array&&) noexcept = default;
       ~texture_n_array()
        {
        ...
        auto operator=(texture_n_array&&) noexcept -> texture_n_array& = default;
