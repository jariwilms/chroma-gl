...
//    //            {
//    //                const auto& [identifier, surface, format] = specification;
//
//    //                switch (surface)
//    //                {
//    //                    case gl::surface_e::texture      : 
//    //                    {
...
//
//    //                        if (attachment == attachment_e::color_0) attachment += color_index++;
//
//    //                        attach(identifier, attachment, texture);
//
//    //                    }
//    //                    case gl::surface_e::cubemap      : 
//    //                    {
...
//
//    //                    }
//    //                    case gl::surface_e::render_buffer: 
//    //                    {
//    //                        auto render_buffer = std::make_shared<gl::render_buffer>(format, dimensions_);
//    //                        auto attachment    = map_render_buffer_attachment(render_buffer->format());
//
//    //                        if (attachment == attachment_e::color_0) attachment += color_index++;
//
