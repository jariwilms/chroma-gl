...
export namespace gl
{
    ...
    struct multisample_frame_buffer_specification
    {
        ...
        multisample_frame_buffer_specification(const std::string& identifier, gl::multisample_frame_buffer_surface_e surface, format_t format)
            : identifier{ identifier }, surface{ surface }, format{ format } {}
    ...
    public:
            ...
            , textures_{}, cubemaps_{}, render_buffers_{}, dimensions_{ dimensions }
        {
            ...
            else
            {
                ...
                for (const auto [color_index, color_attachment] : std::views::enumerate(color_attachments))
                {
    ...
    public:
        ...
        explicit
        multisample_frame_buffer(const gl::multisample_frame_buffer_attachment_map_t attachment_map, const gl::vector_2u& dimensions, gl::uint32_t sample_count)
            : gl::object{ gl::create_frame_buffer() }
