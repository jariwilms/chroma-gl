...
export namespace gl
{
    ...
    public:
        ...
        explicit
        cubemap(format_e format, gl::vector_1u dimensions, gl::bool_t allocate_mipmaps = gl::true_)
    ...
    public:
        ...
        explicit
        cubemap_array(gl::count_t element_count, format_e format, gl::vector_1u dimensions, gl::bool_t allocate_mipmaps = gl::true_)
