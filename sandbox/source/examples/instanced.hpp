...
static inline void instanced()
{
    ...
    auto       window                 = rgfw::window{ "instanced", window_dimensions, window_flags };
    ...
    auto pipeline                     = gl::create_pipeline_from_files(
        {
            { gl::shader::type_e::vertex  , "assets/shaders/compiled/instanced.vert.spv" },
            { gl::shader::type_e::fragment, "assets/shaders/compiled/instanced.frag.spv" },
        });
